...
$string['createmultiplesessions_help'] = '<p>This function allows you to create multiple sessions in one simple 
  step. <p />
...
$string['display_help'] = '<p>Use this option to modify the way the attendance record is displayed. 
...
$string['hiddensessions_help'] = '<p>Session hides if course\'s start date older than its date. 
Change start date of course and hidden sessions will be shown.</p>
<p>You can use this feature to hide older sessions instead delete. 
...
$string['sessions_help'] = '<p>Attendance sessions are shown here. If no sessions appear, click 
  on the &quot;Add&quot; tab to create new sessions. </p>
<p>Take attendance by clicking on the green icon under the &quot;actions&quot; 
  menu (left side). </p>
<p>Edit each session by clicking on the middle &quot;edit session&quot; 
  icon. After taking attendance you can edit the session by clicking on the description. 
</p>
<p>Delete the session entirely by clicking on the delete icon on 
  the right side.</p>';
...
$string['str_ftimedm'] = '%d.%m';
$string['str_ftimedate'] = '%d.%m.%Y';
$string['str_ftimedmy'] = '%d.%m.%Y';
$string['str_ftimedmyhm'] = '%d.%m.%Y %H.%M'; // line added to allow multiple sessions in the same day
$string['str_ftimedmyw'] = '%d.%m.%y&nbsp;(%a)';
$string['str_ftimehm'] = '%H:%M'; //line added to allow display of time
$string['str_ftimeshortdate'] = '%d.%m.%Y';
